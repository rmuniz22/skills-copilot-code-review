...
initial_announcements = [
    {
        "_id": "bem-vindos-ao-semestre",
        "title": "Boas-vindas ao novo semestre",
        "message": "As inscricoes para atividades extracurriculares estao abertas. Confira as vagas e garanta sua participacao.",
        "starts_at": None,
